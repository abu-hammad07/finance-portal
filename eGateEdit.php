                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <div class="card h-auto">
                                <div class="card-body">
                                    ...
                                    <hr class="my-4">
                                    <div class="row g-3">
                                        <input type="text" hidden name="eGate_id" class="form-control"
                                            value="<?= $row['eGate_id'] ?>">
                                        <div class="col-md-6">
                                            <label class="form-label">House Number / Shop Number</label>
                                            <select name="house_id" id="house_id" class="form-select form-control house-id"
                                                required>
                                        ...
                                        <div class="col-md-6" style="display:none">
                                            ...
                                            <select name="house_or_shop" id="house_or_shop"
                                                class="form-select form-control house-or-shop" required>
