    ...
    <div class="d2c_wrapper">
        ...
        <div class="d2c_main p-4 ps-lg-3">
            ...
            ?>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <button type="button" class="btn btn-primary" onclick="printContent()"><i class="fas fa-print"></i></button>
                                            </div>
                        ...
                        <!-- -------------Print----------- -->
                        <div class="content-wrapper" id="printable-content">
                            ...
                            <div class="container">
                                ...
                                <div class="terms">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque euismod orci ut et lobortis. Suspendisse potenti.</p>
                                </div>
