                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6 ">
                                            ...
                                            <input type="text" readonly id="vehicle_name" name="vehicle_name" class="form-control" placeholder="Honda City" value="<?= $row['vehicle_name'] ?>" required>
                                            <!-- <span class="text-danger" id="vehicle_name_error"></span> -->
                                        </div>
                                        <div class="col-md-6 ">
                                            <label class="form-label">Vehicle Number</label>
                                            <input type="text" readonly id="vehicle_number" name="vehicle_number" class="form-control" placeholder="ABC-12345" value="<?= $row['vehicle_number'] ?>" required>
                                            <!-- <span class="text-danger" id="vehicle_number_error"></span> -->
                                        </div>
                                        <div class="col-md-6 ">
                                            <label class="form-label">Vehicle Color</label>
                                            <input type="text" readonly id="vehicle_color" name="vehicle_color" class="form-control" placeholder="Black" value="<?= $row['vehicle_color'] ?>" required>
                                            <!-- <span class="text-danger" id="vehicle_color_error"></span> -->
                                        </div>
                                        <div class="col-md-6 ">
                                            <label class="form-label">Person Name</label>
                                            <input type="test" readonly id="person_name" name="person_name" class="form-control" placeholder="John Doe" value="<?= $row['eGateperson_name'] ?>">
                                            <!-- <span class="text-danger" id="person_name_error"></span> -->
                                        </div>
                                        <div class="col-md-6 ">
                                            <label class="form-label">CNIC Number</label>
                                            <input type="text" readonly id="cnic_number" name="cnic_number" class="form-control" placeholder="XXXXX-XXXXXXX-X" value="<?= $row['eGate_cnic'] ?>">
