...
function filter_user_data_In_Database($userLimited, $userOrder)
{
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <tr>
                                                    ...
                                                    <td>' . $row['status'] . '</td>
                                                    <td>
                                                        <a href="income-edit.php?income_edit_id=' . $row['user_id'] . '">
                                                            <span>
                                                                <i class="fas fa-pencil-alt me-1 text-success"></i>
                                                            </span>
                                                        </a>
                                                        <a class="" href="income-view.php?income_view_id=' . $row['user_id'] . '">
                                                        ...
                                                        <div class="modal fade" id="deleteIncome' . $row['user_id'] . '" tabindex="-1" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer justify-content-start" style="margin-top: -20px;">
                                                                        <a href="?income_delete_id=' . $row['user_id'] . '" class="btn btn-danger" name="delete_Income">Delete</a>
