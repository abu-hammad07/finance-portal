...
function addPenalty()
{
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $insertQuery = "INSERT INTO penalty(penalty_type, penalty_cnic, penalty_charges, payment_type, created_date,
          created_by) VALUES ('$penalty_type','$penalty_cnic','$penalty_charges','$paymentType',
          '$added_on','$added_by')";
...
function updatePenalty()
{
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $insertQuery = "UPDATE penalty SET 
        penalty_type = '{$penalty_type}',
        penalty_cnic = '{$penalty_cnic}',
