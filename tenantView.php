                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6 ">
                                            ...
                                            <input type="text" readonly id="tenant-name" name="tenant_name" class="form-control" placeholder="Enter Tenant's Name" value="<?= $row['tenant_name'] ?>" required>
                                            <!-- <span class="text-danger" id="tenants-name_error"></span> -->
                                        </div>
                                        <div class="col-md-6 ">
                                            <label class="form-label">Tenant's Contact Number</label>
                                            <input type="number" readonly id="tenant-contact" name="tenant_contact" class="form-control" placeholder="03XXXXXXXXX" value="<?= $row['tenant_contact_no'] ?>" required>
                                            <!-- <span class="text-danger" id="tenant-contact_error"></span> -->
                                        </div>
                                        <div class="col-md-6 ">
                                            <label class="form-label">Tenant's CNIC</label>
                                            <input type="number" readonly id="tenant-contact" name="tenant_cnic" class="form-control" placeholder="XXXXX-XXXXXXX-X" value="<?= $row['tenant_cnic'] ?>" required>
