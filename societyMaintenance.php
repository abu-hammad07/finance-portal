        ...
        <div class="col-lg-12 mb-4">
            <div class="card card-body h-auto d2c_projects_datatable">
                <div class="row">
                    <div class="col-md-4 col-12 mt-2">
                        <form class="position-relative">
                            <input type="text" class="form-control product-search ps-5 word-spacing-2px"
                                id="MaintType-search_societyMaint" placeholder="Search Maintenance Type &nbsp;..." />
                    ...
                    <div class="col-md-4 col mt-2">
                        <select id="societyMaint-limit" class="form-control form-select"
                            onchange="load_societyMaint_Data()">
                    ...
                    <div class="col-md-4 col-12 mt-2">
                        <button type="button" class="btn btn-primary w-100"
                            onclick="search_societyMaint_Data()">Search</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-end card-header">
                        <div class="btn-group">
                            ...
                            <div class="mb-2">
                                <a href="addSocietyMaintenance" class="btn btn-primary"><i class="fas fa-plus"></i>
                                    Utility
                                    CHarges</a>
                            </div>
                        </div>
...
<script>
    ...
    function search_societyMaint_Data() {
        ...
        let societyMaintSearch = document.getElementById('MaintType-search_societyMaint').value;
        let societyMaintLimited = $("#societyMaint-limit").val();
        let societyMaintDate = $("#societyMaint-date").val();
