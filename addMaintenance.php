                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" required name="penalty_month">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" required name="penalty_cnic" class="form-control" placeholder="Penalty Charges" required>
                                <span class="text-danger" id="Penal-Cnic_error"></span>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Maintenance Charges</label>
                                <input type="text" required name="penalty_charges" class="form-control" placeholder="Penalty Charges" required>
